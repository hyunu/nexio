...
#include "ble.hpp"
#include "uart.hpp"
#include "http_board.hpp"
#include "ws_board.hpp"

// Rest of firmware (kept identical)...
...
// The contents of firmware.ino are included via src/main.cpp wrapper to
// allow PlatformIO to preprocess Arduino sketch properly.
